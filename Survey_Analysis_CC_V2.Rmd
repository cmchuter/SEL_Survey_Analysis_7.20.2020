...
##############################################################################
library(haven)
full <- read_dta("C:/Users/clair/Downloads/Survey_Analysis.dta")
View(full)

##Load Academic Data
library(haven)
full_academic <- read_dta("C:/Users/clair/Downloads/Survey_Analysis_academic.dta")
View(full_academic)

##Load Emotional Well-Being Data
full_emotional <- read_dta("C:/Users/clair/Downloads/Survey_Analysis_emotional.dta")
View(full_emotional)

##Load Social Relationships Data
full_social <- read_dta("C:/Users/clair/Downloads/Survey_Analysis_social.dta")
View(full_social)

##Load Problem Behaviors Data
full_problem <- read_dta("C:/Users/clair/Downloads/Survey_Analysis_problem.dta")
View(full_problem)
```
...
#terms_1 <- c("as.factor(TypeofMeasure)")
...
## Meta-Regression
# save list of moderators to include
terms_1 <- c("Targeted_c", "Middle_c", "High_c", "Other_report_c", "Standardized_assessment_c", "MOOSES_Rating_5_c")
...
terms_2 <- c("as.factor(TypeofMeasure)")
...
## Meta-Regression
# save list of moderators to include
#terms_2 <- c("Targeted_c", "Middle_c", "High_c", "Other_report_c", "Standardized_assessment_c", "MOOSES_Rating_5_c")
...
#terms_3 <- c("as.factor(TypeofMeasure)")
...
## Meta-Regression
# save list of moderators to include
terms_3 <- c("Targeted_c", "Middle_c", "High_c", "Other_report_c", "Standardized_assessment_c")
...
terms_4 <- c("as.factor(TypeofMeasure)")
...
## Meta-Regression
# save list of moderators to include
#terms_4 <- c("Targeted_c", "Middle_c", "High_c", "Other_report_c", "Standardized_assessment_c", #"MOOSES_Rating_5_c")
